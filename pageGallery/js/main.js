...
function translatePage(translated) {
  if (!translated) {
    ...
    document.getElementById("revolution-text").textContent =
      "Революция 1906-1907";
    document.getElementById("culture-text").textContent =
    ...
    document.getElementById("about-3").textContent =
    ...
    document.getElementById("spb-text").textContent =
    ...
    document.getElementById("about-2").textContent =
      "This section contains all the photographs presented at the exhibition in the museum.";
    document.getElementById("about-3").textContent =
      "As well as unique post-processing using neural networks.";
